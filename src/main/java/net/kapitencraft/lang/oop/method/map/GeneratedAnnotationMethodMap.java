...
public class GeneratedAnnotationMethodMap extends AnnotationMethodMap {
    ...
    public static GeneratedAnnotationMethodMap read(JsonObject data, String methods) {
        ...
        object.asMap().forEach((string, jsonElement) -> map.put(string, GeneratedAnnotationCallable.of((JsonObject) jsonElement)));
    ...
    public JsonElement save(CacheBuilder builder) {
        ...
        methods.forEach((string, annotationCallable) -> object.add(string, ((GeneratedAnnotationCallable) annotationCallable).save(builder)));
        return object;
    }
}
