...
public enum Opcode {
    ...
    IA_STORE(false), DA_STORE(false), CA_STORE(false), FA_STORE(false), RA_STORE(false),
    IA_LOAD, DA_LOAD, CA_LOAD, FA_LOAD, RA_LOAD,
    I_M1, I_0, I_1, I_2, I_3, I_4, I_5,
    D_M1, D_1,
    F_M1, F_1,
    I_CONST, D_CONST, S_CONST, F_CONST,
    INVOKE_VIRTUAL(false), INVOKE_STATIC(false),
    CONCENTRATION, D2F,
    AND, XOR, OR, NOT,
    EQUAL,
    NEQUAL,
    ...
    GET_FIELD, GET_STATIC, PUT_FIELD(false), PUT_STATIC(false), NEW;
